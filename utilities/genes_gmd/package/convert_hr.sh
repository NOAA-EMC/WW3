#!/bin/sh
# ---------------------------------------------------------------------------- #
# convert_hr.sh  : Convert hurricane grads files from big to little endian     #
#                  and from absolute to difference.                            #
#                                                                              #
# usage: convert_hr.sh runID [compID]                                          #
#                                                                              #
...
# swap=
  ...
  echo "   Convert hurricane run GrADS files and place result in main directory."
...
!
      write (*,999)
!
  900 format (/' convert test_hr output'/ &
               '------------------------')
...
# 5.  Convert data sets and place in main directory
  ...
  do
    ...
    if [ "$file" = 'grd1' ]
    then
      input="55 55 $two F 16"
    else
      input="51 51 $two F 16"
    fi
...
# 6. End of script
  ...
  echo ' '
  echo 'End of convert_hr.sh' 

# End of convert_hr.sh ------------------------------------------------------- #
