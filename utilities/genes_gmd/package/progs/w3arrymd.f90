...
!                .      .    .                                       .
! MODULE:        W3ARRYMD    Array IO service routines.
!   PRGMMR: H.L. Tolman      ORG: W/NP21      DATE: 2008-02-21
!
! ABSTRACT: A gathering of servise routines for IO of speific
!   arrays in WAVEWATCH III.
!
! PROGRAM HISTORY LOG:
! 1999-11-29  Tolman      Origination.
! 2008-02-21  Tolman      Bug fix OUTA2R.
!
...
!                .      .    .                                       .
! SUBPROGRAM:    INA2R       Read 2-D real array
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1998-10-29
!
! ABSTRACT: Read 2-D real array
!
! PROGRAM HISTORY LOG:
! 1993-03-31  Tolman      Origination,
! 1998-10-29  Chen/Tolman Add docblock.
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    INA2I       Read 2-D integer array
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Read 2-D integer array.
!
! PROGRAM HISTORY LOG:
! 1993-03-31  Tolman      Origination.
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    OUTA2R      Write 2-D real array
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 2008-02-21
!
! ABSTRACT: Write 2-D real array
!
! PROGRAM HISTORY LOG:
! 1993-03-31  Tolman      Origination,
! 1999-11-29  Tolman      FORTRAN 90 version.
! 2008-02-21  Tolman      Bug fix IDFM=1, IDLA=2 write.
!
! USAGE: See documentation below.
!
! REMARKS: See documentation below.
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    OUTA2I      Write 2-D integer array
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Write 2-D integer array.
!
! PROGRAM HISTORY LOG:
! 1993-03-31  Tolman      Origination.
! 1999-11-29  Tolman      FORTRAN 90 version.
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    OUTREA      Print 1D real array.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Print 1D real array.
!
! PROGRAM HISTORY LOG:
! 1999-11-29  Tolman      Origination,
!
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    OUTINT      Print 1D integer array.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Print 1D integer array.
!
! PROGRAM HISTORY LOG:
! 1999-11-29  Tolman      Origination,
!
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    OUTMAT      Print 2D real array.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Print 2D real array.
!
! PROGRAM HISTORY LOG:
! 1999-11-29  Tolman      Origination,
!
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    PRTBLK      Print block-type table of 2D real array.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Print block-type table of 2D real array.
!
! PROGRAM HISTORY LOG:
! 1999-11-29  Tolman      Origination.
!
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    PRT1DS      Print plot of 1-D spectrum.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Print plot of 1-D spectrum.
!
! PROGRAM HISTORY LOG:
! 1992-03-10  Tolman      Origination.
! 1998-10-29  Chen/Tolman Adding docblock.
! 1999-11-29  Tolman      FORTRAN 90 version.
!
! USAGE: See documentation below.
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    PRT1DM      Print plot of 1-D spectra.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-29
!
! ABSTRACT: Print plot of 1-D spectra.
!
! PROGRAM HISTORY LOG:
! 1992-04-17  Tolman      Origination.
! 1998-10-29  Chen/Tolman Adding docblock.
! 1999-11-29  Tolman      FORTRAN 90 version.
!
! USAGE: See documentation below.
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    PRT2DS      Print plot of 2-D spectrum.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-10-29
!
! ABSTRACT: Print plot of 2-D spectrum.
!
! PROGRAM HISTORY LOG:
! 1996-06-07  Tolman      Origination.
! 1998-10-29  Chen/Tolman Adding docblock.
! 1999-11-29  Tolman      FORTRAN 90 version.
!
! USAGE: See original documentation.
!
! REMARKS: See original documentation.
!
! ATTRIBUTES:
!   LANGUAGE: FORTRAN 90
!   MACHINE:  Portable code
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    ANGSTR      Convert direction to descriptive string
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1998-10-29
!
! ABSTRACT: Convert direction to descriptive string
!
! PROGRAM HISTORY LOG:
! 1992-03-10  Tolman      Origination
! 1998-10-29  Chen/Tolman Adding docblock.
! 1999-11-29  Tolman      FOTRAN 90 version.
!
! USAGE: See documentation below.
!
! REMARKS: See documentation below.
