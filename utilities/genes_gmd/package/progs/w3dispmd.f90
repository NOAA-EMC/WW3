...
!                .      .    .                                       .
! MODULE:        W3DISPMD    Dispersion relation.
!   PRGMMR: H.L. Tolman      ORG: W/NP21      DATE: 1999-11-30
!
! ABSTRACT: This is a set of subroutines to solve the gravity water
!   wave dispersion relation either directly or though an interpol-
!   ation table.
!
! PROGRAM HISTORY LOG:
...
!                .      .    .                                       .
! SUBPROGRAM:    WAVNU1      Dispersion relation
!   PRGMMR: H.S. CHEN        ORG: W/NP21     DATE: 1998-10-30
!
! ABSTRACT: ITERATIVELY SOLVES THE DISPERSION RELATION FOR SURFACE
!   GRAVITY WAVES GIVEN THE FREQUENCY AND DEPTH
!
! PROGRAM HISTORY LOG:
!   90-11-04  H.L. TOLMAN ORIGINATION
!   98-10-30  H.S. CHEN   ADDING DOCBLOCK
!             H.L. TOLMAN
!
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    WAVNU2      Dispersion relation
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-30
!
! ABSTRACT: Solve the dispersion relation for gravity surface water
!   waves.
!
! PROGRAM HISTORY LOG:
! 1990-07-17  Tolman      Origination.
! 1998-11-05  Chen/Tolman Adding docblock.
! 1990-11-30  Tolman      FORTRAN 90 version.
!
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!                .      .    .                                       .
! SUBPROGRAM:    DISTAB      Interpolation table.
!   PRGMMR: H.L. Tolman      ORG: W/NP21     DATE: 1999-11-30
!
! ABSTRACT: Fills an interpolation table for the solution of the
!   dispaersion relation for gravity water waves in restricted water
!   depths.
!
! PROGRAM HISTORY LOG:
! 1999-11-30  Tolman      Origination.
