...
Chawla (NCEP), Henrique Alves (RSG at NCEP), Erick Rogers and Tim Campbell
(NRL Stennis) contributed to this report.
...
practices report was first provided with model versions 3.14 for two
