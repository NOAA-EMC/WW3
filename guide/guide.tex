...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\manver}{5.00}
\newcommand{\manref}{tol:MMAB14a}
...
\citep{tol:OMB99a,tol:OMB02c, tol:MMAB09a, tol:MMAB14a}. This best practices
guide was first provided with model versions 3.14 for two reasons. First,
coding standards are needed to foster and support community model
development. This has become particularly important with the National
