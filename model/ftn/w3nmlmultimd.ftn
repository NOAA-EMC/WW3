...
!/    09-Aug-2016 : Adding comments                     ( version 5.12 )
!/    15-May-2018 : Update namelist                     ( version 6.05 )
!/    22-Mar-2021 : Update namelist, new input fields   ( version 7.xx )
!/
!  1. Purpose :
!
!
...
#ifdef W3_COU
    ALLTYPE%COUPLING%SENT      = 'unset'
    ALLTYPE%COUPLING%RECEIVED  = 'unset'
    ALLTYPE%COUPLING%COUPLET0  = .FALSE.
#endif // W3_COU
...
#ifdef W3_COU
    ALLDATE%COUPLING%START = '19680606 000000'
    ALLDATE%COUPLING%STRIDE = '0'
    ALLDATE%COUPLING%STOP = '19680607 000000'
#endif // W3_COU
