...
!  1. Purpose :
!
!     Dummy slot for bottom scattering source term.
...
!      Name      Type  Scope    Description
!     ----------------------------------------------------------------
!      W3SBSX    Subr. Public   User supplied bottom scattering.
!      INSBSX    Subr. Public   Corresponding initialization routine.
!     ----------------------------------------------------------------
!
...
!  1. Purpose :
!
!     Slot for user-supplied bottom scattering source term.
!
!  2. Method :
!
!  3. Parameters :
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3SBSX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!/
!/ End of W3SBSX ----------------------------------------------------- /
!/
      END SUBROUTINE W3SBSX
!/ ------------------------------------------------------------------- /
      SUBROUTINE INSBSX
!/
!/                  +-----------------------------------+
...
!      Name      Type  Module   Description
!     ----------------------------------------------------------------
!      W3SBSX    Subr. W3SBSXMD Corresponding source term.
!     ----------------------------------------------------------------
!
!  6. Error messages :
!
...
!/ End of INSBSX ----------------------------------------------------- /
!/
      END SUBROUTINE INSBSX
!/
!/ End of module INSBSXMD -------------------------------------------- /
!/
      END MODULE W3SBSXMD
