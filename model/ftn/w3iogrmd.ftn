...
!/FLX5      TNAMEF = 'Direct use of stress          '
...
!/NL5      TNAME2 = 'Generalized Kinetic Equation  '
...
!/SMC          WRITE (NDSM) NGLO, NARC, NBGL, NBAC, NBSMC
!
          WRITE (NDSM)                                                &
...
!/T            FNAME4, FNAME5, FNAME6, FNAMEP, FNAMEG,                &
!/T            FNAMEF, FNAMEI
...
!/SMC          WRITE (NDSM)  IJKCel, IJKUFc, IJKVFc, ISMCBP
!/SMC          WRITE (NDSM)  ICLBAC 
!/SMC          WRITE (NDSM)  ANGARC 
!/SMC          WRITE (NDSM)  CTRNX,  CTRNY,  CLATF
!/SMC          IF ( FLTEST ) THEN
!/SMC            WRITE (NDSE,"('  NRLv, MRFct and NBSMC values are',3I9)") NRLv, MRFct, NBSMC
...
!/SMC          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                &
!/SMC                     IJKCel, IJKUFc, IJKVFc, ISMCBP 
!/SMC          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                &
!/SMC                     ICLBAC 
!/SMC          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                &
!/SMC                     ANGARC 
...
!/NL5      IF (WRITE) THEN
!/NL5          CALL INSNL5
!/NL5          WRITE (NDSM) QR5DPT, QR5OML, QI5DIS, QI5KEV,           &
!/NL5                       QI5NNZ, QI5IPL, QI5PMX
!/NL5      ELSE
!/NL5          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                &
!/NL5                       QR5DPT, QR5OML, QI5DIS, QI5KEV,           &
!/NL5                       QI5NNZ, QI5IPL, QI5PMX
!/NL5      END IF
!/NL5      IF ( FLTEST ) WRITE (NDST,9051) QR5DPT, QR5OML, QI5DIS,    &
!/NL5                                      QI5KEV, QI5NNZ, QI5IPL,    &
!/NL5                                      QI5PMX
!
!/NLS      IF ( WRITE ) THEN
!/NLS          WRITE (NDSM)                                           &
...
!
!/SMC      IF ( WRITE ) THEN
!/SMC          WRITE(NDSM) DTMS, Refran, FUNO3, FVERG, FSWND, ARCTC
!/SMC        ELSE
!/SMC          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                &
!/SMC                      DTMS, Refran, FUNO3, FVERG, FSWND, ARCTC
!/SMC        END IF
!
!/SMC      IF ( FLTEST ) WRITE (NDST,9260) DTMS, Refran
!
!/FLD1      IF ( WRITE ) THEN
...
!/NL4              '      DATA   : ',I4,I4)
!
!/NL5 9051 FORMAT (' TEST W3IOGR : MODULE W3GDATMD SNLP'/             &
!/NL5              '      DATA   : ', F7.1, F8.2, 2I2.1, I12, 2I2.1)
!
...
!/PR3              '      DATA   : ',2F6.2)
!
!/SMC 9260 FORMAT (' TEST W3IOGR : MODULE W3GDATMD SMCG'/             &
!/SMC              '      DATA   : ',3E10.3)
!
