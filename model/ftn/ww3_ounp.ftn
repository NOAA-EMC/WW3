...
!/NL5 3961 FORMAT (/' *** WAVEWATCH-III WARNING IN W3OUNP :'/         &
...
!/FLX5          TAUDIR1(J1) =  MOD ( 270. - TAUDO(INDREQ(J1))*RADE , 360. )
        END DO
!
...
!/SETUP        IF (NCTYPE.EQ.4) IRET=NF90_DEF_VAR_DEFLATE(NCID, VARID(11), 1, 1, DEFLATE)
