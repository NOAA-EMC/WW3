...
!/FLX5      REAL, INTENT(IN)        :: TAUA, TAUADIR, DAIR
...
!
!/FLX5      IF (.TRUE.) THEN
!/FLX5        CALL W3FLX5 ( ZZWND, U, UDIR, TAUA, TAUADIR, DAIR,  & 
!/FLX5                                          USTAR, USDIR, Z0, CD )
!/FLX5        IF (USTAR.GT.0.001) THEN
!/FLX5          CHARN = GRAV*Z0/USTAR**2 
!/FLX5        ELSE
!/FLX5          CHARN = AALPHA
!/FLX5          END IF
!/FLX5        ELSE
