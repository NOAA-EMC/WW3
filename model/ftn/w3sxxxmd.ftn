...
!  1. Purpose :
!
!     Dummy slot for arbitrary additional source term.
...
!      Name      Type  Scope    Description
!     ----------------------------------------------------------------
!      W3SXXX    Subr. Public   User supplied source term.
!      INSXXX    Subr. Public   Corresponding initialization routine.
!     ----------------------------------------------------------------
!
...
!  1. Purpose :
!
!     Slot for user-supplied source term.
!
!  2. Method :
!
!  3. Parameters :
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3SXXX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!/
!/ End of W3SXXX ----------------------------------------------------- /
!/
      END SUBROUTINE W3SXXX
!/ ------------------------------------------------------------------- /
      SUBROUTINE INSXXX
!/
!/                  +-----------------------------------+
...
!      Name      Type  Module   Description
!     ----------------------------------------------------------------
!      W3SXXX    Subr. W3SXXXMD Corresponding source term.
!     ----------------------------------------------------------------
!
!  6. Error messages :
!
...
!/ End of INSXXX ----------------------------------------------------- /
!/
      END SUBROUTINE INSXXX
!/
!/ End of module INSXXXMD -------------------------------------------- /
!/
      END MODULE W3SXXXMD
