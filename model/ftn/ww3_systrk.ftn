...
!/TRKNC      endif
!/TRKNC      if(outputType.EQ.4) call check( nf90_create(file_name,NF90_NETCDF4,ncid))
...
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,lat_varid,1,1,deflate) )
!/TRKNC      call check( nf90_def_var(ncid, lon_name, NF90_REAL, lon_dimid,lon_varid))
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,lon_varid,1,1,deflate) )
!/TRKNC      call check( nf90_def_var(ncid,time_name,NF90_DOUBLE,rec_dimid,rec_varid))
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,rec_varid,1,1,deflate) )
!
...
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,var1_varid,1,1,deflate) )
...
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,var2_varid,1,1,deflate) )
...
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,var3_varid,1,1,deflate) )
...
!/TRKNC      if(outputType.EQ.4) call check( nf90_def_var_deflate(ncid,var4_varid,1,1,deflate) )
...
!/TRKNC          latitude_id)
!/TRKNC      call check(iret)
!/TRKNC      if (outputType.EQ.4) call check( nf90_def_var_deflate(ncid,latitude_id,1,1,deflate))
!/TRKNC      iret = nf90_def_var(ncid, 'longitude', NF90_REAL, point_dim, &
!/TRKNC        longitude_id)
!/TRKNC      call check(iret)
!/TRKNC      if (outputType.EQ.4) call check( nf90_def_var_deflate(ncid,longitude_id,1,1,deflate))
!/TRKNC      iret = nf90_def_var(ncid, 'time', NF90_DOUBLE, rec_dim, &
!/TRKNC         time_id)
!/TRKNC      call check(iret)
!/TRKNC      if (outputType.EQ.4) call check( nf90_def_var_deflate(ncid,time_id,1,1,deflate) )
...
!/TRKNC        hs_dims, hs_id)
!/TRKNC      call check(iret)
!/TRKNC      if (outputType.EQ.4) call check( nf90_def_var_deflate(ncid,hs_id,1,1,deflate))
...
!/TRKNC        tp_dims, tp_id)
!/TRKNC      call check(iret)
!/TRKNC      if (outputType.EQ.4) call check( nf90_def_var_deflate(ncid,tp_id,1,1,deflate))
...
!/TRKNC      call check(iret)
!/TRKNC      if (outputType.EQ.4) call check( nf90_def_var_deflate(ncid,dir_id,1,1,deflate))
