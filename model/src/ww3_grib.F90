...
#endif // W3_NOGRB
#ifdef W3_NCEP1
      CALL BAOPEN (NDSDAT,'gribfile',IERR)
#endif // W3_NCEP1
#ifdef W3_NCEP2
...
!
      ...
      KGDS( 2) = NX
      KGDS( 3) = NY
      KGDS( 4) = NINT(1000.*(Y0+(REAL(NY-1)*SY)))
      KGDS( 5) = NINT(1000.*X0)
      KGDS( 6) = 128
      KGDS( 7) = NINT(1000.*Y0)
      KGDS( 8) = NINT(1000.*(X0+REAL(NX-1)*SX))
      KGDS( 9) = NINT(1000.*SX)
      KGDS(10) = NINT(1000.*SY)
      KGDS(20) = 255
#endif // W3_NCEP1
!
...
!
        ...
        IF ( RFTIME .LT. 0. ) THEN
#ifdef W3_NCEP1
            KPDS( 8) = 1 + MOD(TIME(1)/10000-1,100)
            KPDS( 9) = MOD(TIME(1),10000) / 100
            KPDS(10) = MOD(TIME(1),100)
            KPDS(11) = TIME(2) / 10000
            KPDS(14) = 0
            KPDS(21) = 1 + (TIME(1)/10000-1)/100
#endif // W3_NCEP1
#ifdef W3_NCEP2
          ...
          ELSE
#ifdef W3_NCEP1
            KPDS( 8) = 1 + MOD(FTIME(1)/10000-1,100)
            KPDS( 9) = MOD(FTIME(1),10000) / 100
            KPDS(10) = MOD(FTIME(1),100)
            KPDS(11) = FTIME(2) / 10000
            KPDS(14) = NINT(RFTIME)
...
!
                ...
                DO IXY=1, NX*NY
                  ...
                  END DO
#ifdef W3_NCEP1
                CALL PUTGB (NDSDAT,NDATA,KPDS,KGDS,BITMAP,YY(:,0),IO)
#endif // W3_NCEP1
#ifdef W3_NCEP2
               ...
               if ((gen_pro.eq.0) .or. (gen_pro.eq.1)) then
                ...
                KPDS(2) = KPDS5A1(I)
                  ...
                  DO IXY=1, NX*NY
                    ...
                    END DO
#ifdef W3_NCEP1
                  CALL PUTGB (NDSDAT,NDATA,KPDS,KGDS,BITMAP,YY(:,I),IO)
#endif // W3_NCEP1
#ifdef W3_NCEP2
                  CALL GRIBCREATE (CGRIB,LCGRIB,LISTSEC0,LISTSEC1,IO)
                  IF (IO .NE. 0) GOTO 810
...
!
#ifdef W3_NCEP1
            CALL PUTGB (NDSDAT,NDATA,KPDS,KGDS,BITMAP,X1,IO)
#endif // W3_NCEP1
#ifdef W3_NCEP2
            CALL GRIBCREATE (CGRIB,LCGRIB,LISTSEC0,LISTSEC1,IO)
            IF (IO .NE. 0) GOTO 810
...
#ifdef W3_NCEP1
                    KPDS(5) = 031
                    CALL PUTGB (NDSDAT,NDATA,KPDS,KGDS,BITMAP,X2,IO)
#endif // W3_NCEP1
#ifdef W3_NCEP2
                    KPDS(2) = 0
                    CALL GRIBCREATE (CGRIB,LCGRIB,LISTSEC0,LISTSEC1,IO)
...
#ifdef W3_NCEP1
                    KPDS(5) = 033
                    CALL PUTGB (NDSDAT,NDATA,KPDS,KGDS,BITMAP,XX,IO)
#endif // W3_NCEP1
#ifdef W3_NCEP2
                    KPDS(2) = 2
                    CALL GRIBCREATE (CGRIB,LCGRIB,LISTSEC0,LISTSEC1,IO)
...
#ifdef W3_NCEP1
                    KPDS(5) = 034
                    CALL PUTGB (NDSDAT,NDATA,KPDS,KGDS,BITMAP,XY,IO)
#endif // W3_NCEP1
#ifdef W3_NCEP2
                    KPDS(2) = 3
                    CALL GRIBCREATE (CGRIB,LCGRIB,LISTSEC0,LISTSEC1,IO)
