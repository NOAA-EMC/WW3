...
#endif
#ifdef W3_T
      INTEGER                 :: NREAD, NTRACK, NSPECO, NLOCO
#endif
#ifdef W3_T3
      INTEGER                 :: ISPT
#endif
...
#endif
              OPEN (NDSTI,FILE=FNMPRE(:J)//'track_i.'//FILEXT(:I),     &
                    STATUS='OLD',ERR=800,form='UNFORMATTED', convert='big_endian',IOSTAT=IERR)
...
!
          IF ( IAPROC .EQ. NAPTRK ) THEN
              ...
              OPEN (NDSTO,FILE=FNMPRE(:J)//'track_o.'//FILEXT(:I),     &
                    form='UNFORMATTED', convert='big_endian',ERR=810,IOSTAT=IERR)
...
!
#ifdef W3_T
 9000 FORMAT (' TEST W3IOTR : MODEL TIME       : ',I8.8,I7.6)
 9010 FORMAT ('               LAST OUTPUT TIME : ',I8.8,I7.6/      &
              '               OUTPUT TIME INC, : ',F6.0/           &
              '               UNIT NUMBERS     : ',2I4/            &
              '               FORMAT FLAGS     : ',L4)
