...
!/    22-Mar-2021 : Extra coupling fields               ( version 7.xx )
!/
...
#endif // W3_TIMINGS
#ifdef W3_PDLIB
!/DEBUGCOH     USE PDLIB_W3PROFSMD, ONLY: ALL_VA_INTEGRAL_PRINT, TEST_MPI_STATUS
!/DEBUGINIT    USE PDLIB_W3PROFSMD, ONLY: PRINT_WN_STATISTIC
#endif // W3_PDLIB
#ifdef W3_UOST
...
#ifdef W3_PDLIB
    ELSE
!/DEBUGINIT      WRITE(*,*) 'Before PDLIB_STYLE_INIT, IMOD=', IMOD
      CALL PDLIB_STYLE_INIT(IMOD)
!/DEBUGINIT     WRITE(740+IAPROC,*) 'After set up of NSEAL, NSEALM=', NSEALM
!/DEBUGINIT     WRITE(740+IAPROC,*) 'After PDLIB_STYLE_INIT'
...
#ifdef W3_PDLIB
!/DEBUGINIT      WRITE(*,*) 'After PDLIB_STYLE_INIT, IMOD=', IMOD
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "Before W3IORS call")
#endif // W3_PDLIB
#ifdef W3_DEBUGINIT
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "After W3IORS call")
#endif // W3_PDLIB
#ifdef W3_DEBUGINIT
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 4.2")
#endif // W3_PDLIB
#ifdef W3_TIMINGS
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 4.3")
#endif // W3_PDLIB
!
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 5")
#endif // W3_PDLIB
      IF ( RSTYPE .EQ. 4 ) THEN
          VA(:,:) = 0.
#ifdef W3_T
...
#ifdef W3_PDLIB
!/DEBUGINIT     WRITE(740+IAPROC,*) 'W3INIT definition of FSREFR and FRFREQ'
!/DEBUGINIT     WRITE(740+IAPROC,*) 'FSTOTALIMP=', FSTOTALIMP
!/DEBUGINIT     WRITE(740+IAPROC,*) 'FSREFRACTION=', FSREFRACTION
!/DEBUGINIT     WRITE(740+IAPROC,*) 'FSFREQSHIFT=', FSFREQSHIFT
!/DEBUGINIT     WRITE(740+IAPROC,*) 'Before FLCTH=', FLCTH, 'FLCK=', FLCK
        ...
        IF (FSTOTALIMP .and. FSFREQSHIFT) THEN
          FLCK = .FALSE.
        END IF
!/DEBUGINIT     WRITE(740+IAPROC,*) ' After FLCTH=', FLCTH, 'FLCK=', FLCK
#endif // W3_PDLIB
!
! 4.  Set-up output times -------------------------------------------- *
! 4.a Unpack ODAT
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 6")
#endif // W3_PDLIB
!
      FLOUT(7) = .FALSE.
      FLOGR2   = FLGR2
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 7")
#endif // W3_PDLIB
#ifdef W3_DEBUGINIT
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 8.1")
#endif // W3_PDLIB
!
...
#ifdef W3_PDLIB
!/DEBUGINIT     WRITE(740+IAPROC,*) 'Before INIT_GET_JSEA_ISPROC call'
!/DEBUGINIT     WRITE(740+IAPROC,*) 'allocated(ISEA_TO_JSEA)=', allocated(ISEA_TO_JSEA)
!/DEBUGINIT     WRITE(740+IAPROC,*) 'NAPROC=', NAPROC
!/DEBUGINIT     FLUSH(740+IAPROC)
#endif // W3_PDLIB
...
#endif // W3_DEBUGINIT
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 8.2")
#endif // W3_PDLIB
...
!
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 8.3")
#endif // W3_PDLIB
!!/PDLIB         CALL VA_SETUP_IOBPD
#ifdef W3_PDLIB
!/DEBUGCOH          CALL ALL_VA_INTEGRAL_PRINT(IMOD, "W3INIT, step 8.4")
#endif // W3_PDLIB
#ifdef W3_DEBUGINIT
...
!
#ifdef W3_PDLIB
!/DEBUGINIT         CALL PRINT_WN_STATISTIC("W3INIT leaving")
#endif // W3_PDLIB
#ifdef W3_TIMINGS
...
!
#ifdef W3_MPI
          NRQMAX = 1+0+0 + 19+0+0 + 0+0+0 +                     &
                   2+(NOGE(4)-2)*(NOSWLL+1) + 11+3+1 +          &
                   10+7+1 + 5+4+1 + 5+2+0 + 5+NOEXTR
          DO IFJ=1,5
