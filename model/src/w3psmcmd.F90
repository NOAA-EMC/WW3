...
#endif // W3_OMPG
#ifdef W3_ARC
  !Li  Polar cell needs a special area factor, one-level case.
...
!$OMP END Parallel 
 ...
 !!Li  Polar cell (if any) keep original value. 
       IF( NSEA .GT. NGLO ) CVQ(NSEA) = CNST0
#endif // W3_ARC
