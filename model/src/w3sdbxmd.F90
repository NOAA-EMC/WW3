...
!  1. Purpose :
!
!     Dummy slot for depth-induced breaking source term.
...
!      Name      Type  Scope    Description
!     ----------------------------------------------------------------
!      W3SDBX    Subr. Public   User supplied depth-inducded breaking.
!      INSDBX    Subr. Public   Corresponding initialization routine.
!     ----------------------------------------------------------------
!
...
!  1. Purpose :
!
!     Slot for user-supplied depth-induced breaking source term.
!
!  2. Method :
!
!  3. Parameters :
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3SDBX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!/
!/ End of W3SDBX ----------------------------------------------------- /
!/
      END SUBROUTINE W3SDBX
!/ ------------------------------------------------------------------- /
      SUBROUTINE INSDBX
!/
!/                  +-----------------------------------+
...
!      Name      Type  Module   Description
!     ----------------------------------------------------------------
!      W3SDBX    Subr. W3SDBXMD Corresponding source term.
!     ----------------------------------------------------------------
!
!  6. Error messages :
!
...
!/ End of INSDBX ----------------------------------------------------- /
!/
      END SUBROUTINE INSDBX
!/
!/ End of module INSDBXMD -------------------------------------------- /
!/
      END MODULE W3SDBXMD
