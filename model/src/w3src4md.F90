...
!
      ...
      NOFILE=.TRUE.
      OPEN (993,FILE=FNAMETAB,form='UNFORMATTED', convert='big_endian',IOSTAT=IERR,STATUS='OLD')
      IF (IERR.EQ.0) THEN 
...
!
      ...
      WRITE (NDST,9000) K,L,I,UST0,AALPHA+FLOAT(L)*DELALP,LEVTAIL,TAUHFT2(K,L,I)
          ...
          END DO
        DEALLOCATE(W)
        OPEN (993,FILE=FNAMETAB,form='UNFORMATTED', convert='big_endian',IOSTAT=IERR,STATUS='UNKNOWN')
