...
!  1. Purpose :
!
!     Dummy slot for stress computation.
!        This module can be used to include user-defined stresses
!     or to submit a routine to be included into the WAVEWATCH III
...
!      Name      Type  Scope    Description
!     ----------------------------------------------------------------
!      W3FLXX    Subr. Public   User supplied linear input.
!      INFLXX    Subr. Public   Corresponding initialization routine.
!     ----------------------------------------------------------------
!
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3FLXX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!
!
...
!/ End of INFLXX ----------------------------------------------------- /
!/
      END SUBROUTINE INFLXX
!/
!/ End of module INFLXXMD -------------------------------------------- /
!/
      END MODULE W3FLXXMD
