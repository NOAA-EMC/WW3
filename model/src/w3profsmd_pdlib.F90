...
CONTAINS
  ...
  SUBROUTINE PDLIB_INIT(IMOD)
    ...
    WRITE(*,*) 'IMPTOTAL=', IMPTOTAL
    WRITE(*,*) 'EXPTOTAL=', EXPTOTAL
    WRITE(*,*) 'IMPFSN=', IMPFSN
    WRITE(*,*) 'EXPFSN=', EXPFSN
    WRITE(*,*) 'EXPFSPSI=', EXPFSPSI
    WRITE(*,*) 'EXPFSFCT=', EXPFSFCT
    WRITE(*,*) 'IMPREFRACTION=', IMPREFRACTION
    WRITE(*,*) 'IMPFREQSHIFT=', IMPFREQSHIFT
    WRITE(*,*) 'IMPSOURCE=', IMPSOURCE
    WRITE(*,*) 'NAPROC=', NAPROC
    WRITE(*,*) 'NTPROC=', NTPROC
