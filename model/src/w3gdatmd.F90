...
MODULE W3GDATMD
  ...
  TYPE GRID          ! this is the geographical grid with all associated parameters
     ...
     INTEGER                   :: NITERSEC1
     INTEGER, POINTER          :: MAPSTA(:,:), MAPST2(:,:), MAPFS(:,:), MAPSF(:,:)
     !
#ifdef W3_SMC
     ...
     LOGICAL                    :: GINIT, FLDRY, FLCX, FLCY, FLCTH, FLCK, FLSOU, IICEDISP, IICESMOOTH
     LOGICAL                   :: FLAGLL
     LOGICAL                   :: CMPRTRCK
     ...
     INTEGER, POINTER       :: CCON(:), COUNTCON(:), IE_CELL(:), POS_CELL(:)
  ...
  TYPE SGRD   ! this is the spectral grid with all parameters that vary with freq. and direction
     ...
     REAL, POINTER          :: TH(:), ESIN(:), ECOS(:), ES2(:), ESC(:), EC2(:), SIG(:), SIG2(:)
     REAL, POINTER          :: DSIP(:), DSII(:), DDEN(:), DDEN2(:)
     LOGICAL                :: SINIT=.FALSE.
  END TYPE SGRD
  !
  TYPE NPAR
     REAL               :: FACP, XREL, XFLT, FXFM, FXPM, XFT, XFC, FACSD, FHMAX
#ifdef W3_RWND
     REAL               :: RWINDC
#endif
#ifdef W3_WCOR
  ...
  TYPE SRCP
...
#endif
#ifdef W3_ST2
     REAL               :: ZWIND, FSWELL, SHSTAB, OFSTAB, CCNG, CCPS, FFNG, FFPS
     REAL               :: CDSA0, CDSA1, CDSA2, SDSALN
     REAL               :: CDSB0, CDSB1, CDSB2, CDSB3, FPIMIN, XFH, XF1, XF2
#endif
#ifdef W3_ST3
     ...
     REAL               :: SSDSP, WWNMEANP, SSTXFTF, SSTXFTWN, FFXPM, FFXFM
     REAL               :: SSDSC4, SSDSC5, SSDSC6, DDELTA1, DDELTA2, ZZWND
#endif
     !
#ifdef W3_ST4
     ...
     REAL               :: AALPHA, BBETA, ZZ0MAX, ZZ0RAT, ZZALP
     REAL               :: SSINTHP, TTAUWSHELTER, SSWELLF(1:7), SSDSC(1:21), SSDSBR
     REAL               :: SSDSP, WWNMEANP, SSTXFTF, SSTXFTWN, FFXPM, FFXFM, FFXFA
     REAL               :: SSDSBRF1, SSDSBRF2, SSDSBINT,SSDSBCK, SSDSHCK, SSDSABK, SSDSPBK
     REAL               :: SSINBR, ZZWND
     REAL               :: SSDSCOS, SSDSDTH, SSDSBT, SSDSBM(0:4)
#endif
     !
#ifdef W3_ST6
     REAL               :: SIN6A0, SDS6A1, SDS6A2, SWL6B1, SIN6WS, SIN6FC
  ...
  TYPE SNLP
...
#endif
#ifdef W3_NL1
     REAL               :: SNLC1, LAM, KDCON, KDMN, SNLS1, SNLS2, SNLS3
#endif
#ifdef W3_NL2
...
#endif
#ifdef W3_NL3
     INTEGER            :: NFRMIN, NFRMAX, NFRCUT, NTHMAX, NTHEXP, NSPMIN, NSPMAX, NSPMX2
     INTEGER            :: NQA, SNLNQ
     INTEGER, POINTER   :: QST1(:,:,:), QST4(:,:,:)
     REAL               :: SNLMSC, SNLNSC, SNLSFD, SNLSFS
     REAL, POINTER      :: FRQ(:), XSI(:), QST2(:,:,:), QST3(:,:,:), QST5(:,:,:), QST6(:,:,:)
     REAL, POINTER      :: SNLL(:), SNLM(:), SNLT(:),  SNLCD(:), SNLCS(:)
#endif
#ifdef W3_NL4
     INTEGER            :: ITSA, IALT
#endif
     ...
     REAL               :: CNLSA, CNLSC, CNLSFM, CNLSC1, CNLSC2, CNLSC3
     REAL, POINTER      :: SNSST(:,:)
#endif
  ...
  REAL,      POINTER :: ANGLE(:,:),ANGLE0(:,:)
  INTEGER,   POINTER :: CCON(:),  COUNTCON(:), IE_CELL(:), POS_CELL(:), IAA(:), JAA(:)
  INTEGER,   POINTER :: POSI(:,:), I_DIAG(:), JA_IE(:,:,:), INDEX_CELL(:)
  INTEGER*2, POINTER :: IOBP(:)
  INTEGER*1, POINTER :: IOBPD(:,:), IOBDP(:), IOBPA(:)
  REAL(8),   POINTER :: TRIA(:)
  REAL,      POINTER :: CROSSDIFF(:,:)
  ...
  REAL, POINTER              :: SX, SY, X0, Y0, DTCFL, DTCFLI, DTMAX, DTMIN, DMIN, CTMAX, FICE0, FICEN
  REAL, POINTER              :: FICEL, PFMOVE, STEXU, STEYU, STEDU, IICEHMIN, IICEHINIT, ICESCALES(:)
  REAL, POINTER              :: IICEHFAC, IICEHDISP, IICEDDISP, IICEFDISP, BTBETA, AAIRCMIN, AAIRGB
  ...
  LOGICAL, POINTER           :: GINIT, FLDRY, FLCX, FLCY, FLCTH, FLCK, FLSOU, IICEDISP, IICESMOOTH
  ...
  INTEGER, POINTER :: MAPWN(:), MAPTH(:)
  REAL,    POINTER :: DTH, XFR, FR1, FTE, FTF, FTWN, FTTR, FTWL, FACTI1, FACTI2, FACHFA, FACHFE
  REAL,    POINTER :: TH(:), ESIN(:), ECOS(:), ES2(:), ESC(:), EC2(:), SIG(:), SIG2(:)
  REAL,    POINTER :: DSIP(:), DSII(:), DDEN(:), DDEN2(:)
  ...
  !/
  REAL, POINTER        :: FACP, XREL, XFLT, FXFM, FXPM, XFT, XFC, FACSD, FHMAX
#ifdef W3_RWND
  REAL, POINTER        :: RWINDC
#endif
#ifdef W3_WCOR
...
#endif
#ifdef W3_ST2
  REAL,    POINTER :: ZWIND, FSWELL, SHSTAB, OFSTAB, CCNG, CCPS, FFNG, FFPS
  REAL,    POINTER :: CDSA0, CDSA1, CDSA2, SDSALN, CDSB0, CDSB1, CDSB2, CDSB3
  REAL,    POINTER :: FPIMIN, XFH, XF1, XF2
#endif
#ifdef W3_ST3
  REAL,    POINTER :: ZZWND, AALPHA, BBETA, ZZ0MAX, ZZ0RAT, ZZALP, FFXFM, FFXPM
  REAL,    POINTER :: SSINTHP, TTAUWSHELTER, SSWELLF(:), SSDSC1, SSDSC2, SSDSC3, SSDSBR
  REAL,    POINTER :: SSDSP, WWNMEANP, SSTXFTF, SSTXFTWN, SSDSC4, SSDSC5, SSDSC6, SSDSBT
  REAL,    POINTER :: DDELTA1, DDELTA2, SSDSCOS, SSDSDTH, SSDSBM(:)
#endif
#ifdef W3_ST4
  INTEGER, POINTER :: SSWELLFPAR, SSDSISO,SSDSBRFDF, IKTAB(:,:), SATINDICES(:,:),SSDSDIK
  REAL,    POINTER :: DCKI(:,:), SATWEIGHTS(:,:),CUMULW(:,:),QBI(:,:)
  REAL,    POINTER :: ZZWND, AALPHA, BBETA, ZZ0MAX, ZZ0RAT, ZZALP, FFXFA
  REAL,    POINTER :: FFXFM, FFXPM, SSDSBRF1, SSDSBRF2, SSDSBINT, SSDSBCK, SSDSHCK, SSDSABK
  REAL,    POINTER :: SSDSPBK, SSINBR,SSINTHP,TTAUWSHELTER, SSWELLF(:), SSDSC(:), SSDSBR
  REAL,    POINTER :: SSDSP, WWNMEANP, SSTXFTF, SSTXFTWN, SSDSBT, SSDSCOS, SSDSDTH, SSDSBM(:)
#endif
#ifdef W3_ST6
  REAL,    POINTER :: SIN6A0, SDS6A1, SDS6A2, SWL6B1, SIN6WS, SIN6FC
...
#endif
#ifdef W3_NL3
  INTEGER, POINTER :: NFRMIN, NFRMAX, NFRCUT, NTHMAX, NTHEXP, NSPMIN, NSPMAX, NSPMX2, NQA, SNLNQ
  INTEGER, POINTER :: QST1(:,:,:), QST4(:,:,:)
  ...
  REAL, POINTER            :: CNLSA, CNLSC, CNLSFM, CNLSC1, CNLSC2, CNLSC3, SNSST(:,:)
#endif
  !/
...
9003 FORMAT (' TEST W3DIMS : DIMENSIONS STORED')
  ...
  SUBROUTINE W3SETG ( IMOD, NDSE, NDST )
    ...
    !/ Local parameters
    !/
    INTEGER, SAVE           :: IENT = 0 ! only for W3_S
    !/
    if (w3_s_flag) then
