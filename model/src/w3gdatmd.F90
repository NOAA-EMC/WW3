...
!
#ifdef W3_ARC
        INTEGER               :: NGLO, NARC, NBGL, NBAC
        INTEGER, POINTER      :: ICLBAC(:)
#endif // W3_ARC
!
...
#endif // W3_PR3
#ifdef W3_SMC
        REAL                  :: DTME, CLATMN, Refran
        LOGICAL               :: FUNO3, FVERG, FSWND 
#endif // W3_SMC
      END TYPE PROP
!
      TYPE FLDP
...
!
#ifdef W3_ARC
        INTEGER, POINTER      :: NGLO, NARC, NBGL, NBAC
        INTEGER, POINTER      :: ICLBAC(:)
#endif // W3_ARC
!
#ifdef W3_SEC1
...
#endif // W3_PR3
#ifdef W3_SMC
      REAL, POINTER           :: DTME, CLATMN, Refran
      LOGICAL, POINTER        :: FUNO3, FVERG, FSWND 
#endif // W3_SMC
!/
...
!
#ifdef W3_ARC
      ALLOCATE ( GRIDS(IMOD)%ICLBAC(MBAC),       &
                 GRIDS(IMOD)%ANGARC(MARC),       &
                 GRIDS(IMOD)%SPCBAC(MSPEC,MBAC), &
                 STAT=ISTAT                      )
      CHECK_ALLOC_STATUS ( ISTAT )
#endif // W3_ARC
!
