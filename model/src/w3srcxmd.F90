...
!/    08-Oct-2007 : Adding dummy routine W3SPRX.        ( version 3.13 )
...
!  1. Purpose :
!
!     Dummy slot for input and whitecapping  source terms.
...
!  1. Purpose :
!
!     Slot for routine computing mean parameters.
!
!  2. Method :
!
!  3. Parameters :
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3SPRX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!/
!/ End of W3SPRX ----------------------------------------------------- /
...
!  1. Purpose :
!
!     Slot for user-supplied input source term.
!
!  2. Method :
!
!  3. Parameters :
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3SINX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!/
!/ End of W3SINX ----------------------------------------------------- /
...
!
      WRITE (NDSE,*)
      WRITE (NDSE,*) ' *** ROUTINE W3SDSX NOT YET AVAILABLE *** '
      WRITE (NDSE,*)
      CALL EXTCDE ( 99 )
!/
!/ End of W3SDSX ----------------------------------------------------- /
