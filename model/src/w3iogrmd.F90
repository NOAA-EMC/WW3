...
#endif // W3_UNO
#ifdef W3_SMC
      TNAMEP = 'UNO2 on SMC grid propagation  '
#endif // W3_SMC
#ifdef W3_PRX
      TNAMEP = 'Experimental                  '
#endif // W3_PRX
...
#endif // W3_SMC
#ifdef W3_ARC
          WRITE (NDSM) NGLO, NARC, NBGL, NBAC
#endif // W3_ARC
!
          WRITE (NDSM)                                                &
...
!
         ...
         WRITE (NDSM)  IJKCel, IJKUFc, IJKVFc
#endif // W3_SMC
#ifdef W3_ARC
         WRITE (NDSM)  ICLBAC 
         WRITE (NDSM)  ANGARC 
         ...
         IF ( FLTEST ) THEN
            WRITE (NDSE,"('  NLvCel, NLvUFc, NLvVFc Write for',2I9)") NRLv, MRFct
...
#ifdef W3_SMC
      IF ( WRITE ) THEN
          WRITE (NDSM) DTME, CLATMN, Refran, FUNO3, FVERG, FSWND
        ELSE
          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                &
                       DTME, CLATMN, Refran, FUNO3, FVERG, FSWND
        END IF
#endif // W3_SMC
!
#ifdef W3_SMC
      IF ( FLTEST ) WRITE (NDST,9060) DTME, CLATMN, Refran
#endif // W3_SMC
!
#ifdef W3_FLD1
      IF ( WRITE ) THEN
