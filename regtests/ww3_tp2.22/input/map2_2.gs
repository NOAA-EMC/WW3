*
* map2_2.gs    : GrADS wave heigt and mean direction for ww3_tp2.2
* ----------------------------------------------------------------
...
* Plot wave heights
  ...
  'set gxout shaded'
  'set clevs  0.05 0.1 0.15 0.2 0.25 0.3 0.4 0.5 0.6 0.7 0.8 0.9 1.0 1.25 1.5 2. 3'
...
* Text around plot
  ...
  'set strsiz 0.18'
  'set string 1 c 5'
  'draw string 5.5 7.7 WAVEWATCH III TEST'

  'set strsiz 0.12'
  'set string 1 l'
  'draw string  0.5 7.3 Propagation test ww3_tp2.2'
  'set string 1 r'
  'draw string 10.5 7.3 valid ' vdate
  'set string 1 c'
  'draw string 5.5 1.0 wave height (shaded, m) and mean direction (vector, not scaled)'
  'draw string 5.5 7.3 plot generated ' gdate

*  Print this page and clear

  'printim map2_2_'t'.png'
  'clear'
  'set grads off'
