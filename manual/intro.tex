...
required to offer the same to NOAA for inclusion under the instant licensing terms
...
model input and output. In the later case, the software offered shall not include
