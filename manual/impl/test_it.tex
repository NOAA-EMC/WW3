...
\fit{ww3\_ufs1.1}{Tests for global 1deg grid w/ ww3\_multi/ww3\_multi\_esmf; wind/current/ice inputs; grid integration using ww3\_gint; ww3\_grib outputs; restart/MPI task/thread reproducibility (ufs app)}
\fit{ww3\_ufs1.2}{Tests for GFSv16 setup with ww3\_multi/ww3\_multi\_esmf; wind/current/ice inputs; grid integration using ww3\_gint; ww3\_grib outputs; restart reproducibility (ufs app)}
\end{flist}
