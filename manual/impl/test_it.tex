...
\fit{ww3\_tp2.7}{\ldots}
\fit{ww3\_tp2.8}{\ldots}
\fit{ww3\_tp2.9}{\ldots}
...
\fit{mww3\_test\_06}{\ldots}
\fit{mww3\_test\_07}{\ldots}
\end{flist}

\noindent These regression tests are now run using the {\file run\_test}
script in the {\file regtests/bin} directory. How to run this script,
