...
\sit{oasis }{Initializes OASIS Coupler (App.~\ref{app:couplingB}).}   
\sit{oasacm}{OASIS atmospheric model coupling fields(App.~\ref{app:couplingB}).}
\sit{oasocm}{OASIS oceanic model coupling fields (App.~\ref{app:couplingB}).}
