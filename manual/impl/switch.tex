...
\noindent
Selection of method of momentum interpolation (time):
\begin{slist}
\sit{att0}{No interpolation.}
\sit{att1}{Linear interpolation.}
\sit{att2}{Approximately quadratic interpolation.}
\end{slist}

\noindent
Selection of method of momentum interpolation (space):
\begin{slist}
\sit{atx0}{Vector interpolation.}
\sit{atx1}{Approximately linear speed interpolation.}
\sit{atx2}{Approximately quadratic speed interpolation.}
\end{slist}
...
% \sit{att1} {Momentum interpolation (linear).}
% \sit{atx1} {Momentum interpolation (linear).}
