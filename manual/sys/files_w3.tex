...
\fit{diagonalize}{Square matrix diagonalization}
\fit{rotate}{Square matrix rotation, used by DIAGONALIZE}
\end{flisti}
...
\begin{flisti}
\fit{w3ref1}{Calculation of $S_{ref}$, possibly including a free infragravity source.}
\end{flisti}
...
\centerline{\ldots update w3wave figure \ldots}
\vspace{\baselineskip}
...
Fig.~\ref{fig:w3init} (page~\pageref{fig:w3init}). A similar relational
