...
install program will create the (hidden) setup file {\file .wwatch3.env} in
the user's home directory. The setup can be modified by rerunning the install
program, or by manually editing the setup file {\file .wwatch3.env}. The
...
\noindent
The use of these scripts is explained in \para\ref{sec:comp}. After this, several GrADS scripts are installed in the {\dir aux} directory.
