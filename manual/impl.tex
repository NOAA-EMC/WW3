...
\begin{slist}
\sit{nopa}{Compilation as a subroutine }
\sit{palm}{Compilation as a stand-alone program}
\end{slist}
...
\sit{nc3} {Activates the possibility to use on NetCDF3 for input or output}
\sit{nc4} {Activates the possibility to use on NetCDF4 for input or output}
