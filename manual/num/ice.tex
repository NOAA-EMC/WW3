\vssub
\subsection{~Ice coverage ({\code IC0})} \label{sub:num_ice}
...
The above description pertains to the switch {\code IC0}. Note that either ice transparency for propagation ({\code IC0}), or ice as a source term can be used ({\code IC1}, {\code IC2}, {\code IC3}), but not both approaches at the same time.
