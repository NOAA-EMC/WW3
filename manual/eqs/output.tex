...
\item \textbf{TM10} Mean wave period (s) [see Eq.~(\ref{eq:zbar})]
      \begin{equation} T_{m-1,0} = 2\pi \overline{\sigma^{-1}}
      \: . \label{eq:Tmm10} \end{equation}
...
\item \textbf{PTE} Wave energy period of partitions of the spectrum [see Eq.~(\ref{eq:Tmm10})] 
