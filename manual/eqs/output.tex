...
%\item \textbf{PTE} Wave energy period of partitions of the spectrum [see Eq.~(\ref{eq:Tm0m1})] (NOT PLUGGED YET)
%\item \textbf{PT1} Mean wave period of partitions of the spectrum [see Eq.~(\ref{eq:Tm})] (NOT PLUGGED YET)
%\item \textbf{PT2} Wave zero-upcrossing period of partitions of the spectrum [see Eq.~(\ref{eq:Tm02})] (NOT PLUGGED YET)
%\item \textbf{PEP} Wave peak spectral density of partitions (NOT PLUGGED YET)
\end{list}
