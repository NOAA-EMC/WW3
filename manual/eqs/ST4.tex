...
\noindent 
This parameterization uses a positive part of the wind input taken
...
\hline
  ...
  $\beta_{\mathrm{max}}$ & BETAMAX    & SIN4 & 1.43    &\textbf{1.33}& \textbf{1.55}    &  \textbf{1.52}   \\
  $p_{\mathrm{in}}$ &  SINTHP         & SIN4 & 2       & 2       & 2         &  2      \\
  $z_\alpha$ &  ZALP                  & SIN4 & 0.006   & 0.006   & 0.006     &  0.006 \\
  $s_u$ &  TAUWSHELTER                & SIN4 & 0.3     & 0.3     & \textbf{0.0} & \textbf{1.0}   \\
  $s_1$ &  SWELLF                     & SIN4 & 0.66    & 0.66    & 0.8       &  0.8 \\
  $s_2$ &  SWELLF2                    & SIN4 & -0.018  & -0.018  & -0.018    &  -0.018 \\
  $s_3$ &  SWELLF3                    & SIN4 &  0.022  &  0.022  &  \textbf{0.015}    & \textbf{0.015} \\
  $\mathrm{Re}_c$ &  SWELLF4          & SIN4 & $1.5\times 10^5$  & $1.5\times 10^5$  & $10^5$    & $10^5$  \\
  $s_5$ &  SWELLF5                    & SIN4 & 1.2     & 1.2     & 1.2       &  1.2 \\
  $s_6$ &  SWELLF6                    & SIN4 & 0.      & 0.      & 0.        & 0.   \\
  $s_7$ &  SWELLF7                    & SIN4 & 3.6$\times 10^5$ & 3.6$\times 10^5$  &\textbf{0.0}       &\textbf{0.0} \\
  $z_r$ &  Z0RAT                      & SIN4 & 0.04    & 0.04    & 0.04      &  0.04 \\
  $z_{0,\max}$ &  Z0MAX               & SIN4 & 1.002   & 1.002   &\textbf{0.002}&  1.002 \\
\hline
\end{tabular} }
 \end{center}
\caption{Parameter values for TEST471, TEST471f, TEST405 and TEST500 source 
term parameterizations that can be reset via the {\F SIN4} namelist. TEST471
...
\hline
  ...
  $f_{\mathrm{FM}}$                 &  FXFM3          & SDS4& 2.5 &\textbf{9.9}                 &  2.5 &\textbf{9.9}  \\
                                    & SDSC1           & SDS4 & 0 & 0   & 0                              & \textbf{1.0} \\
  $C_{\mathrm{ds}}^{\mathrm{sat}}$  & SDSC2           & SDS4& $-2.2\times 10^{-5}$  & $-2.2\times 10^{-5}$  & $-2.2\times 10^{-5}$  & \textbf{0.0} \\
  $C_{\mathrm{ds}}^{\mathrm{BCK}}$  & SDSBCK          & SDS4 & 0 & 0                     & 0  & \textbf{0.185} \\
  $C_{\mathrm{ds}}^{\mathrm{HCK}}$  & SDSHCK           & SDS4& 0 & 0                    & 1.5  & 1.5 \\
  $\Delta_\theta$                   &  SDSDTH         & SDS4 & 80 & 80                    & 80 &  80 \\
  $B_r$                             &  SDSBR          & SDS4  & 0.0009& 0.0009                & \textbf{0.00085} & 0.0009    \\
  $C_{\mathrm{cu}}$                 & SDSCUM         & SDS4 & -0.40344  & -0.40344               & \textbf{0.0}    & -0.40344     \\
  ${\mathrm{s_B}}$                  & SDSCOS           &SDS4  & 2.0& 2.0                   &  0.0 & 2.0 \\
   $B_0$                             &  SDSC4          & SDS4 & 1.0 & 1.0                  & 1.0 & 1.0   \\
  $p^{\mathrm{sat}}$                &  SDSP           & SDS4 & 2.0& 2.0  & 2.0 &  2.0   \\
  $C_{\mathrm{turb}}$               & SDSC5           & SDS4  & 0.0& 0.0 & 0.0 &  0.0   \\
  $\delta_d$                        & SDSC6           & SDS4  & 0.3& 0.3 & 0.3 &  0.3   \\
  $C$                               & NLPROP          & SNL1  & $2.5\times 10^7$& $2.5\times 10^7$ & $\mathbf{2.7\times 10^7}$  & $2.5\times 10^7$   \\
 \hline \hline
