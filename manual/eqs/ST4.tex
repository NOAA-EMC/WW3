...
Par.                               &  WWATCH var.  & namelist  & T471        & T405             & T500         & T601   \\
\hline
  $f_{\mathrm{FM}}$                &  FXFM3        & SDS4      & 2.5         & 2.5              &\textbf{9.9}  & 5      \\
                                   & SDSC1         & SDS4      & 0           & 0                &\textbf{1.0}  & 0      \\
  $C_{\mathrm{ds}}^{\mathrm{sat}}$ & SDSC2         & SDS4      &$-2.2\X^{-5}$&$-2.2\X^{-5}$     &\textbf{0.0}  &$-2.2\X^{-5}$ \\
  ...
  $B_r$                            & SDSBR         & SDS4      & 0.0009      &\textbf{0.00085}  & 0.0009       & 0.0009   \\
